...
} from "./chunk-OLFYXW3W.js";
import {
  require_react_dom
} from "./chunk-QO4QGXZJ.js";
import {
  composeRefs,
  createSlot,
  createSlottable,
  dist_exports,
  useComposedRefs
} from "./chunk-LQWKZY4O.js";
import {
  require_jsx_runtime
} from "./chunk-BUIOFNEI.js";
import {
  require_react
} from "./chunk-NHPH4WP4.js";
import {
  __export,
  __privateAdd,
  __privateGet,
...
var AvatarImage = React34.forwardRef(
  (props, forwardedRef) => {
    ...
    const loadingStatusRef = React34.useRef(imageLoadingStatus);
    useLayoutEffect2(() => {
...
function useImageCount() {
  ...
  if (true) {
    state = React34.useState(0);
    const [imageCount] = state;
    const hasWarnedRef = React34.useRef(false);
    React34.useEffect(() => {
...
var Popper = (props) => {
  ...
  const [placementState, setPlacementState] = React40.useState(void 0);
...
var PopperAnchor = React40.forwardRef(
  (props, forwardedRef) => {
    ...
    const callbackRef = React40.useCallback(
      (node) => {
        ref.current = node;
        if (node) {
          onAnchorChange(node);
...
var ContextMenu = (props) => {
  ...
  const hasInteractedRef = React43.useRef(false);
  if (true) {
    const hasWarnedRef = React43.useRef(false);
    React43.useEffect(() => {
...
function useIsHydrated() {
  const [isHydrated, setIsHydrated] = React49.useState(_isHydrated);
  React49.useEffect(() => {
    if (!_isHydrated) {
      _isHydrated = true;
      setIsHydrated(true);
...
var OneTimePasswordField = React50.forwardRef(
  function OneTimePasswordFieldImpl({
    ...
    const sanitizeValue = React50.useCallback(
      (value2) => {
    ...
    const controlledValue = React50.useMemo(() => {
    ...
    const [value, setValue] = useControllableState({
      ...
      onChange: React50.useCallback(
        (value2) => onValueChange == null ? void 0 : onValueChange(value2.join("")),
        [onValueChange]
      )
    });
    const latestValueRef = React50.useRef(value);
    latestValueRef.current = value;
    const dispatch = React50.useCallback(
      (action) => {
    ...
    const validationTypeRef = React50.useRef(validation);
    React50.useEffect(() => {
      var _a3;
      if (!validation) {
        return;
    ...
    const hiddenInputRef = React50.useRef(null);
    const userActionRef = React50.useRef(null);
    ...
    const locateForm = React50.useCallback(() => {
      var _a3;
      let formElement;
      if (form) {
    ...
    const attemptSubmit = React50.useCallback(() => {
    ...
    const valueRef = React50.useRef(currentValue);
...
var OneTimePasswordFieldHiddenInput = React50.forwardRef(function OneTimePasswordFieldHiddenInput2({ __scopeOneTimePasswordField, ...props }, forwardedRef) {
...
var OneTimePasswordFieldInput = React50.forwardRef(function OneTimePasswordFieldInput2({
  __scopeOneTimePasswordField,
  onInvalidChange,
  index: indexProp,
  ...props
  ...
  const [element, setElement] = React50.useState(null);
  ...
  const keyboardActionTimeoutRef = React50.useRef(null);
  React50.useEffect(() => {
    return () => {
...
var PasswordToggleField = ({
  ...
  const [inputIdState, setInputIdState] = React51.useState(defaultInputId);
  const inputId = inputIdState ?? defaultInputId;
  const syncInputId = React51.useCallback(
  ...
  const focusState = React51.useRef(INITIAL_FOCUS_STATE);
...
var PasswordToggleFieldInput = React51.forwardRef(
  ({
    __scopePasswordToggleField,
...
var PasswordToggleFieldToggle = React51.forwardRef(
  ({
    __scopePasswordToggleField,
    onClick,
    onPointerDown,
    ...
    const [internalAriaLabel, setInternalAriaLabel] = React51.useState(void 0);
...
var PasswordToggleFieldIcon = React51.forwardRef(
  ({
    __scopePasswordToggleField,
    // @ts-expect-error
    children,
...
var PopoverAnchor = React52.forwardRef(
  (props, forwardedRef) => {
...
var PopoverTrigger = React52.forwardRef(
  (props, forwardedRef) => {
...
var PopoverContent = React52.forwardRef(
  (props, forwardedRef) => {
...
var PopoverContentModal = React52.forwardRef(
  (props, forwardedRef) => {
    const context = usePopoverContext(CONTENT_NAME12, props.__scopePopover);
...
var PopoverContentNonModal = React52.forwardRef(
  (props, forwardedRef) => {
    const context = usePopoverContext(CONTENT_NAME12, props.__scopePopover);
...
var PopoverContentImpl = React52.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopePopover,
      trapFocus,
...
var PopoverClose = React52.forwardRef(
  (props, forwardedRef) => {
...
var PopoverArrow = React52.forwardRef(
  (props, forwardedRef) => {
...
var RadioTrigger = React54.forwardRef(
...
var RadioIndicator = React54.forwardRef(
  (props, forwardedRef) => {
...
var RadioBubbleInput = React54.forwardRef(
  ({ __scopeRadio, ...props }, forwardedRef) => {
    ...
    const defaultCheckedRef = React54.useRef(checked);
    return (0, import_jsx_runtime31.jsx)(
      Primitive.input,
      {
        type: "radio",
...
function SelectProvider(props) {
  ...
  const handleNativeOptionAdd = React56.useCallback((option) => {
    setNativeOptionsSet((prev) => new Set(prev).add(option));
  }, []);
  const handleNativeOptionRemove = React56.useCallback((option) => {
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime34.jsx)(
      Primitive.span,
      {
        ...
        children: (0, import_jsx_runtime34.jsx)(React56.Fragment, { children: showPlaceholder ? placeholder : children }, showPlaceholder ? "placeholder" : "value")
      }
    );
  }
);
...
var SelectContentFragment = React56.forwardRef((props, forwardedRef) => {
...
var SelectContentImpl = React56.forwardRef(
  (props, forwardedRef) => {
    ...
    useFocusGuards();
    const focusFirst6 = React56.useCallback(
      (candidates) => {
...
var SelectBubbleInput = React56.forwardRef(
...
var Separator3 = React57.forwardRef((props, forwardedRef) => {
...
var Slider = React58.forwardRef(
  (props, forwardedRef) => {
    ...
    const isKeyboardInteractionRef = React58.useRef(false);
...
var SliderThumbTrigger = React58.forwardRef(
  (props, forwardedRef) => {
...
var SliderBubbleInput = React58.forwardRef(
...
function SwitchProvider(props) {
  ...
  const [control, setControl] = React59.useState(null);
  const [bubbleInput, setBubbleInput] = React59.useState(null);
...
var SwitchTrigger = React59.forwardRef(
...
var SwitchBubbleInput = React59.forwardRef(
  ({ __scopeSwitch, ...props }, forwardedRef) => {
    ...
    const defaultCheckedRef = React59.useRef(checked);
    return (0, import_jsx_runtime37.jsx)(
      Primitive.input,
      {
        type: "checkbox",
...
var ToggleGroup = React63.forwardRef((props, forwardedRef) => {
...
var ToggleGroupImplSingle = React63.forwardRef((props, forwardedRef) => {
  const {
    value: valueProp,
    defaultValue,
    onValueChange = () => {
  ...
  return (0, import_jsx_runtime41.jsx)(
    ToggleGroupValueProvider,
    {
      ...
      type: "single",
      value: React63.useMemo(() => value ? [value] : [], [value]),
      onItemActivate: setValue,
      onItemDeactivate: React63.useCallback(() => setValue(""), [setValue]),
      children: (0, import_jsx_runtime41.jsx)(ToggleGroupImpl, { ...toggleGroupSingleProps, ref: forwardedRef })
    }
  );
});
var ToggleGroupImplMultiple = React63.forwardRef((props, forwardedRef) => {
  const {
    value: valueProp,
    defaultValue,
    onValueChange = () => {
  ...
  const handleButtonActivate = React63.useCallback(
    (itemValue) => setValue((prevValue = []) => [...prevValue, itemValue]),
    [setValue]
  );
  const handleButtonDeactivate = React63.useCallback(
    (itemValue) => setValue((prevValue = []) => prevValue.filter((value2) => value2 !== itemValue)),
    [setValue]
  );
  return (0, import_jsx_runtime41.jsx)(
...
var ToggleGroupImpl = React63.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeToggleGroup,
      disabled = false,
...
var ToggleGroupItem = React63.forwardRef(
  (props, forwardedRef) => {
...
var ToggleGroupItemImpl = React63.forwardRef(
  (props, forwardedRef) => {
...
var Toolbar = React64.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarSeparator = React64.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarButton = React64.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarLink = React64.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarToggleGroup = React64.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarToggleItem = React64.forwardRef(
  (props, forwardedRef) => {
...
var TooltipProvider = (props) => {
  ...
  const isOpenDelayedRef = React65.useRef(true);
  const isPointerInTransitRef = React65.useRef(false);
  ...
  return (0, import_jsx_runtime43.jsx)(
    TooltipProviderContextProvider,
    {
      ...
      isOpenDelayedRef,
      delayDuration,
      onOpen: React65.useCallback(() => {
        if (skipDelayDuration <= 0) return;
        window.clearTimeout(skipDelayTimerRef.current);
        isOpenDelayedRef.current = false;
      }, [skipDelayDuration]),
      onClose: React65.useCallback(() => {
        if (skipDelayDuration <= 0) return;
        window.clearTimeout(skipDelayTimerRef.current);
        skipDelayTimerRef.current = window.setTimeout(
      ...
      onPointerInTransitChange: React65.useCallback((inTransit) => {
...
var Tooltip = (props) => {
  ...
  const [trigger, setTrigger] = React65.useState(null);
  const contentId = useId();
  const openTimerRef = React65.useRef(0);
  const disableHoverableContent = disableHoverableContentProp ?? providerContext.disableHoverableContent;
  const delayDuration = delayDurationProp ?? providerContext.delayDuration;
  const wasOpenDelayedRef = React65.useRef(false);
  const [open, setOpen] = useControllableState({
    prop: openProp,
    defaultProp: defaultOpen ?? false,
    onChange: (open2) => {
  ...
  const stateAttribute = React65.useMemo(() => {
  ...
  return (0, import_jsx_runtime43.jsx)(Root25, { ...popperScope, children: (0, import_jsx_runtime43.jsx)(
    TooltipContextProvider,
    {
      ...
      trigger,
      onTriggerChange: setTrigger,
      onTriggerEnter: React65.useCallback(() => {
        if (providerContext.isOpenDelayedRef.current) handleDelayedOpen();
        else handleOpen();
      }, [providerContext.isOpenDelayedRef, handleDelayedOpen, handleOpen]),
      onTriggerLeave: React65.useCallback(() => {
...
var TooltipTrigger = React65.forwardRef(
  (props, forwardedRef) => {
    ...
    const isPointerDownRef = React65.useRef(false);
    const hasPointerMoveOpenedRef = React65.useRef(false);
    const handlePointerUp = React65.useCallback(() => isPointerDownRef.current = false, []);
    React65.useEffect(() => {
...
var TooltipContent = React65.forwardRef(
  (props, forwardedRef) => {
...
var TooltipContentHoverable = React65.forwardRef((props, forwardedRef) => {
  const context = useTooltipContext(CONTENT_NAME15, props.__scopeTooltip);
  const providerContext = useTooltipProviderContext(CONTENT_NAME15, props.__scopeTooltip);
  const ref = React65.useRef(null);
  const composedRefs = useComposedRefs(forwardedRef, ref);
  const [pointerGraceArea, setPointerGraceArea] = React65.useState(null);
  const { trigger, onClose } = context;
  const content = ref.current;
  const { onPointerInTransitChange } = providerContext;
  const handleRemoveGraceArea = React65.useCallback(() => {
    setPointerGraceArea(null);
    onPointerInTransitChange(false);
  }, [onPointerInTransitChange]);
  const handleCreateGraceArea = React65.useCallback(
    (event, hoverTarget) => {
...
var TooltipContentImpl = React65.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeTooltip,
      children,
...
var TooltipArrow = React65.forwardRef(
  (props, forwardedRef) => {
